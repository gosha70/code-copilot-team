...
assert_eq "test-counts has exactly 20 expected-pass variables (routing-delegation arrived with #254 T3)" "20" "$COUNT_VARS"
...
rc=0
grep -q 'source "\$COUNTS_FILE"' "$REPO_DIR/tests/test-peer-review.sh" || rc=1

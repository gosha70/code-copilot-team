...
Note: refreshed after phase 3 + the P-round fixes: headless recipes doc
(verified --mode json shape, proven through the launcher shim; rpc
honestly bounded), docs integration, fail-loud scaffold (partial sources
fall back or fail, never a lying manifest), timeout clamp, README env
caveats, canary-locality note. Scope unchanged.

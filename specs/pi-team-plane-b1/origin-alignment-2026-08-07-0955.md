...
Note: refreshed after the final-verdict round: ISO-shape timestamp guard
(jam-proof monotonicity), applied-row stat semantics, enforceable
CCT_PHASES/PHASE_ORDER mirror test. Scope unchanged; reviewer verdict
APPROVE.

...
// ── lock ─────────────────────────────────────────────────────────────────────
// The pid/token ledger lock lives in ./ledger-lock.ts (shared with the team
// ledger, #185). Re-exported so existing importers keep resolving it here.
export { withLedgerLock } from "./ledger-lock.ts";
export type { LockOptions } from "./ledger-lock.ts";

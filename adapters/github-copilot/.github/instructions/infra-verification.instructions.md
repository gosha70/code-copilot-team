...
1. Execute every command yourself
2. Report the output of each command
3. Fix any failures before declaring done
4. Do NOT hand an unverified test plan to the user

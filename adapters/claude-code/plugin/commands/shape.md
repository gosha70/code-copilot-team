...
- Write `specs/pitches/<id>/pitch.md` from `${CLAUDE_PLUGIN_ROOT}/templates/sdd/pitch-template.md`
- Set `bet_status: shaped`
- Validate via `${CLAUDE_PLUGIN_ROOT}/templates/sdd/validate-pitch.sh`

...
If the `memkernel` MCP server is configured, read `${CLAUDE_PLUGIN_ROOT}/skills/memkernel-memory/SKILL.md` and retain the finished recap summary when it would help the next session recover context quickly.

...
6. **Render the report.** Write `specs/retros/cooldown-after-<NN>.md` using `${CLAUDE_PLUGIN_ROOT}/templates/sdd/cooldown-report-template.md`. Set frontmatter `cooldown_after_cycle`, `started`, `ended`, `duration` (`1w` or `2w`).

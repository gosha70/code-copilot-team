...
- [Documentation — all of it, grouped](README.md) — Everything written down about Code Copilot Team, grouped the way the Studio's
...
- [Developer Cookbook — the SDLC of this project](developer-cookbook.md) — How a change moves from idea to merged PR in **code-copilot-team**, in two
- [Auto code review — setup cookbook](auto-code-review-setup.md) — How to have a second model review your work automatically: which
- [Feature Index](features.md) — generated from its sources; edit the source, not the page
- [Feature maturity, release state and adapter support](maturity.md) — The feature catalog (`shared/features/catalog.yaml`) records four separate
...
- [Configuration Layers](configuration-layers.md) — Where each rule, skill, agent and hook is installed, and which layer wins when
- [Install Options](install.md) — Every install path, for every tool

### Analytics & benchmarks

- [Session Analytics — user cookbook](session-analytics-cookbook.md) — Session Analytics reads the transcripts your AI coding assistant leaves on
- [Session Analytics](../scripts/session_analytics/README.md) — Copilot session analytics & process-mining pipeline (issue #63) — the
...
- [Knowledge Layer](../knowledge/README.md) — A durable, structured knowledge layer for `code-copilot-team`,
...
- [DGX Spark — setup & cookbook (Ollama, vLLM, Open WebUI)](dgx-spark/setup-cookbook.md) — Working setup and troubleshooting patterns for:
- [DGX Spark + vLLM — Qwen3.8-27B operator manual](dgx-spark/vllm-qwen38.md) — This doc is the Qwen3.8-27B companion to `dgx-spark.md` (general DGX Spark setup), `vllm.md` (general vLLM) and `dgx-spark-vllm.md` (the *verified* Qwen3-Coder-Next-NVFP4 manual)
- [DGX Spark — Qwen3.8-27B runbook (exact sequence)](dgx-spark/runbook-qwen38.md) — Two machines

### Wiki

- [Wiki Overview](../knowledge/wiki/overview.md) — page_type: overview
- [Glossary](../knowledge/wiki/glossary/index.md) — page_type: glossary

### Background

- [Evidence & Influences](evidence-and-influences.md) — External reviews, scorecards, and the sources that shaped this harness
- [Case study: an A/B autonomous build of MAP-ATLAS (Claude Code vs pi.dev)](mapatlas-harness-experiment.md) — A hands-off experiment: two AI coding harnesses built the **same** open-source
